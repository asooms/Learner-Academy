package com.learner_academy.admin;
...
public class DbRetrieve {
	...
	public List<Class> getClasses() {
		...
		try {
			...
			while (myRs.next()) {
				...
				// retrieve data from result set row
				int id = myRs.getInt("id");
				String name = myRs.getString("class_name");
				...
				// create new student object
				Class temp = new Class(id,name, section, teacher_name, tempSubject.getName(), time);
	...
	public boolean addClass(String class_name,int section,int teacher,int subject,String time){
		
		Connection myConn = null;
		PreparedStatement myStmt = null;
		ResultSet myRs = null;
		
		System.out.print("INSERT INTO `classes` VALUES(null,'"+class_name+"','"+section+"','"+teacher+"','"+subject+"','"+time+"')");
		try {
			// get a connection
			myConn = dataSource.getConnection();
			String sql = "INSERT INTO `classes` VALUES(null,'"+class_name+"','"+section+"','"+teacher+"','"+subject+"','"+time+"')";
...
public boolean addStudent(String fristName,String lastName,int age,int classId){
		...
		try {
			// get a connection
			myConn = dataSource.getConnection();
			String sql = "INSERT INTO `students` VALUES(null,'"+fristName+"','"+lastName+"','"+age+"','"+classId+"')";
			myStmt = myConn.prepareStatement(sql);
			// execute query
			myStmt.execute();
			return true;
...
public boolean addTecher(String fristName,String lastName,int age){
	...
	try {
		// get a connection
		myConn = dataSource.getConnection();
		String sql = "INSERT INTO `teachers` VALUES(null,'"+fristName+"','"+lastName+"','"+age+"')";
		myStmt = myConn.prepareStatement(sql);
		// execute query
		myStmt.execute();
		return true;
